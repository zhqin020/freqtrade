...
class PyTorchLSTMRegressor(BasePyTorchRegressor):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        # Allow overriding device from config (default to base class auto-detection)
        self.device = self.freqai_info.get("model_training_parameters", {}).get("device", self.device)
