...
class NostalgiaForInfinityNextGen(IStrategy):
        ...
        if sorted(self.coin_metrics["current_whitelist"]) != sorted(self.dp.current_whitelist()):
            ...
            self.coin_metrics["current_whitelist"].insert(
                ...
                self.coin_metrics["current_whitelist"].pop(
                    self.coin_metrics["current_whitelist"].index(
    ...
    def top_traded_list(self):
        ...
        self.coin_metrics["tt_dataframe"][column_names] = self.coin_metrics["tt_dataframe"].apply(
            lambda x: x.nlargest(self.coin_metrics["top_traded_len"]).index.values,
            axis=1,
            result_type="expand",
        )
        self.coin_metrics["tt_dataframe"].drop(
            columns=[col for col in self.coin_metrics["tt_dataframe"] if col not in column_names],
            inplace=True,
        )
    ...
    def top_grossing_list(self):
        ...
        self.coin_metrics["tg_dataframe"][column_names] = self.coin_metrics["tg_dataframe"].apply(
            lambda x: x.nlargest(self.coin_metrics["top_grossing_len"]).index.values,
            axis=1,
            result_type="expand",
        )
        self.coin_metrics["tg_dataframe"].drop(
            columns=[col for col in self.coin_metrics["tg_dataframe"] if col not in column_names],
            inplace=True,
        )
    ...
    def bot_loop_start(self, **kwargs) -> None:
        ...
        if (
            self.coin_metrics["top_grossing_enabled"]
            and not self.coin_metrics["top_grossing_updated"]
        ):
    ...
    def sell_r(
        ...
        if 0.02 > current_profit >= 0.012:
            if last_candle["r_480"] > -0.4:
                ...
                (last_candle["r_480"] < -65.0)
                and (last_candle["cti"] > 0.95)
            ...
            if last_candle["r_480"] > -0.7:
                ...
                (last_candle["r_480"] > -7.0)
                and (last_candle["rsi_14"] > 74.0)
                and (last_candle["r_480_1h"] > -4.5)
            ):
                return True, "sell_profit_w_4_6"
            elif (
                (last_candle["r_14"] == 0.0)
                and (last_candle["rsi_14"] > 75.5)
                and (last_candle["cci"] > 320.0)
            ):
    ...
    def sell_trail(
        ...
        if 0.02 > current_profit >= 0.012:
            ...
            if (max_profit > (current_profit + 0.095)) and (last_candle["rsi_14"] < 36.0):
                ...
                (max_profit > (current_profit + 0.12))
                and (last_candle["rsi_14"] < 29.0)
                and (last_candle["rsi_14_1h"] < 35.0)
            ):
            ...
            if (max_profit > (current_profit + 0.1)) and (last_candle["rsi_14"] < 34.0):
                ...
                (max_profit > (current_profit + 0.13))
    ...
    def informative_1d_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.coin_metrics["top_traded_enabled"]:
            informative_1d = informative_1d.merge(
                self.coin_metrics["tt_dataframe"], on="date", how="left"
            )
            informative_1d["is_top_traded"] = informative_1d.apply(
                lambda row: self.is_top_coin(
                    metadata["pair"], row, self.coin_metrics["top_traded_len"]
                ),
                axis=1,
            )
            column_names = [f"Coin #{i}" for i in range(1, self.coin_metrics["top_traded_len"] + 1)]
        ...
        if self.coin_metrics["top_grossing_enabled"]:
            informative_1d = informative_1d.merge(
                self.coin_metrics["tg_dataframe"], on="date", how="left"
            )
            informative_1d["is_top_grossing"] = informative_1d.apply(
                lambda row: self.is_top_coin(
                    metadata["pair"], row, self.coin_metrics["top_grossing_len"]
                ),
                axis=1,
            )
            column_names = [
                f"Coin #{i}" for i in range(1, self.coin_metrics["top_grossing_len"] + 1)
            ]
            informative_1d.drop(columns=column_names, inplace=True)
        ...
        informative_1d["open_sha"], informative_1d["close_sha"], informative_1d["low_sha"] = (
            heikin_ashi(informative_1d, smooth_inputs=True, smooth_outputs=False, length=10)
        )
        ...
        sup_series = (
            informative_1d["low"]
            .rolling(window=5, center=True)
            .apply(lambda row: self.is_support(row), raw=True)
            .shift(2)
        )
        informative_1d["res_level"] = Series(
            np.where(
                ...
                np.where(
                    ...
                    informative_1d["close"],
                    informative_1d["open"],
                ),
                float("NaN"),
            )
        ).ffill()
        informative_1d["res_hlevel"] = Series(
            np.where(res_series, informative_1d["high"], float("NaN"))
        ).ffill()
    ...
    def informative_1h_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        informative_1h["sma_200_dec_24"] = informative_1h["sma_200"] < informative_1h[
            "sma_200"
        ].shift(24)
        ...
        informative_1h["res_hlevel"] = Series(
            np.where(res_series, informative_1h["high"], float("NaN"))
        ).ffill()
    ...
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["vol_osc"] = (
            (dataframe["vma_10"] - dataframe["vma_20"]) / dataframe["vma_20"] * 100
        )
        ...
        if not self.config["runmode"].value in ("live", "dry_run"):
            ...
            dataframe.loc[dataframe.index > (12 * 24 * self.bt_min_age_days), "bt_agefilter_ok"] = (
                True
            )
        else:
            # Exchange downtime protection
    ...
    def info_tf_btc_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # -----------------------------------------------------------------------------------------
        dataframe["rsi_14"] = ta.RSI(dataframe, timeperiod=14)
        dataframe["not_downtrend"] = (dataframe["close"] > dataframe["close"].shift(2)) | (
            dataframe["rsi_14"] > 50
        )
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.has_BTC_info_tf:
            ...
            dataframe = merge_informative_pair(
                dataframe, btc_info_tf, self.timeframe, self.info_timeframe_1h, ffill=True
            )
            drop_columns = [
        ...
        if self.has_BTC_base_tf:
            ...
            drop_columns = [
                f"{s}_{self.timeframe}" for s in ["date", "open", "high", "low", "close", "volume"]
            ]
            dataframe.drop(columns=dataframe.columns.intersection(drop_columns), inplace=True)
        ...
        if self.info_timeframe_1d != "none":
            ...
            dataframe = merge_informative_pair(
                dataframe, informative_1d, self.timeframe, self.info_timeframe_1d, ffill=True
            )
            drop_columns = [
        ...
        if self.res_timeframe != "none":
            ...
            dataframe.rename(
                columns=lambda s: f"{s}_{self.res_timeframe}" if "resample_" in s else s,
                inplace=True,
            )
            dataframe.rename(
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        for index in self.buy_protection_params:
            ...
            if self.entry_params[f"buy_condition_{index}_enable"]:
                ...
                if global_buy_protection_params["ema_slow"]:
                    item_buy_protection_list.append(
                        dataframe[f"ema_{global_buy_protection_params['ema_slow_len']}_1h"]
                ...
                if global_buy_protection_params["safe_dips_threshold_0"] is not None:
                    item_buy_protection_list.append(
                        dataframe["tpct_change_0"]
                        < global_buy_protection_params["safe_dips_threshold_0"]
                    )
                if global_buy_protection_params["safe_dips_threshold_2"] is not None:
                    item_buy_protection_list.append(
                        dataframe["tpct_change_2"]
                        < global_buy_protection_params["safe_dips_threshold_2"]
                    )
                if global_buy_protection_params["safe_dips_threshold_12"] is not None:
                    item_buy_protection_list.append(
                        dataframe["tpct_change_12"]
                        < global_buy_protection_params["safe_dips_threshold_12"]
                    )
                if global_buy_protection_params["safe_dips_threshold_144"] is not None:
                    item_buy_protection_list.append(
                        dataframe["tpct_change_144"]
                        < global_buy_protection_params["safe_dips_threshold_144"]
                    )
                if global_buy_protection_params["safe_pump_6h_threshold"] is not None:
                    item_buy_protection_list.append(
                        dataframe["hl_pct_change_6_1h"]
                        < global_buy_protection_params["safe_pump_6h_threshold"]
                    )
                if global_buy_protection_params["safe_pump_12h_threshold"] is not None:
                    item_buy_protection_list.append(
                        dataframe["hl_pct_change_12_1h"]
                        < global_buy_protection_params["safe_pump_12h_threshold"]
                    )
                if global_buy_protection_params["safe_pump_24h_threshold"] is not None:
                    item_buy_protection_list.append(
                        dataframe["hl_pct_change_24_1h"]
                        < global_buy_protection_params["safe_pump_24h_threshold"]
                    )
                if global_buy_protection_params["safe_pump_36h_threshold"] is not None:
                    item_buy_protection_list.append(
                        dataframe["hl_pct_change_36_1h"]
                        < global_buy_protection_params["safe_pump_36h_threshold"]
                    )
                if global_buy_protection_params["safe_pump_48h_threshold"] is not None:
                    item_buy_protection_list.append(
                        dataframe["hl_pct_change_48_1h"]
                        < global_buy_protection_params["safe_pump_48h_threshold"]
                    )
                ...
                if index == 1:
                    ...
                    item_buy_logic.append(
                        (
                            (dataframe["close"] - dataframe["open"].rolling(4).min())
                            / dataframe["open"].rolling(4).min()
                        )
                        > 0.04
                    )
                ...
                # Condition #7 - Semi swing. 1h uptrend.
                    ...
                    item_buy_logic.append(
                        dataframe["ema_200_1h"] > dataframe["ema_200_1h"].shift(4)
                    )
                    item_buy_logic.append(
                        dataframe["ema_200_1h"].shift(4) > dataframe["ema_200_1h"].shift(8)
                    )
                ...
                # Condition #9 - Semi swing. Local deep. Uptrend, 1h uptrend.
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["close"].shift(1) < (dataframe["sma_15"].shift(1) * 0.97)
                    )
                ...
                # Condition #13 - Semi swing. 1h uptrend. BTC not downtrend.
                    ...
                    item_buy_logic.append(dataframe["ema_26"] > dataframe["ema_12"])
                    item_buy_logic.append(
                        (dataframe["ema_26"] - dataframe["ema_12"]) > (dataframe["open"] * 0.0242)
                    )
                    item_buy_logic.append(
                        (dataframe["ema_26"].shift() - dataframe["ema_12"].shift())
                        > (dataframe["open"] / 100)
                ...
                # Condition #14 - Semi swing. Uptrend. Local dip.
                    ...
                    item_buy_logic.append(
                        dataframe["close"].shift(1) < (dataframe["bb20_2_low"].shift(1) * 0.985)
                    )
                ...
                # Condition #16 - Semi swing. Strong uptrend. 1h uptrend. Local dip. BTC not downtrend.
                    ...
                    item_buy_logic.append(
                        dataframe["close"].shift(1) < (dataframe["sma_30"].shift(1) * 0.988)
                    )
                    item_buy_logic.append(
                        dataframe["close"].shift(1) < (dataframe["bb20_2_low"].shift(1) * 0.996)
                    )
                ...
                # Condition #17 - Semi swing. Strong 1h uptrend. BTC not negative. Local dip.
                    ...
                    item_buy_logic.append(
                        dataframe["ema_200_1h"].shift(8) > dataframe["ema_200_1h"].shift(12)
                    )
                ...
                # Condition #20 - Swing. Uptrend. Bounce from daily support level
                    ...
                    item_buy_logic.append(
                        dataframe["open_sha_1d"].shift(96) < dataframe["close_sha_1d"].shift(96)
                    )

                    item_buy_logic.append(
                        dataframe["pivot_1d"] > dataframe["pivot_1d"].shift(96) * 0.95
                    )
...
"""
回测结果：
(.venv) watson@u24:~/work/freqtrd$ freqtrade backtesting --strategy NostalgiaForInfinityNextGen --config user_data/config.json --timerange 20230101-  --strategy-path user_data/freqtrade-strategies/strategies/NostalgiaForInfinityNextGen

2026-04-02 23:32:23,150 - freqtrade.misc - INFO - dumping json to 
"/home/watson/work/freqtrd/user_data/backtest_results/backtest-result-2026-04-02_23-32-23.meta.json"
Result for strategy NostalgiaForInfinityNextGen
                                                 BACKTESTING REPORT                                                  
┏━━━━━━━━━━━━━━━━┳━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━┓
┃           Pair ┃ Trades ┃ Avg Profit % ┃ Tot Profit USDT ┃ Tot Profit % ┃   Avg Duration ┃  Win  Draw  Loss  Win% ┃
┡━━━━━━━━━━━━━━━━╇━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━┩
│ NEAR/USDT:USDT │      8 │         3.09 │          24.074 │         2.41 │        1:00:00 │    8     0     0   100 │
│  SUI/USDT:USDT │      7 │         2.71 │          18.827 │         1.88 │        2:11:00 │    7     0     0   100 │
│ AVAX/USDT:USDT │      8 │         2.25 │          17.555 │         1.76 │        3:41:00 │    8     0     0   100 │
│  ETC/USDT:USDT │      3 │         5.84 │          17.297 │         1.73 │        8:50:00 │    3     0     0   100 │
│ LINK/USDT:USDT │      6 │         2.08 │          12.311 │         1.23 │        0:50:00 │    6     0     0   100 │
│  XRP/USDT:USDT │      5 │         2.37 │          11.811 │         1.18 │        2:51:00 │    5     0     0   100 │
│  SOL/USDT:USDT │      3 │         3.75 │          11.142 │         1.11 │       14:10:00 │    3     0     0   100 │
│ ATOM/USDT:USDT │      5 │         1.99 │           9.255 │         0.93 │        8:42:00 │    5     0     0   100 │
│  ADA/USDT:USDT │      6 │         1.21 │           7.024 │          0.7 │ 1 day, 7:32:00 │    5     0     1  83.3 │
│  LTC/USDT:USDT │      6 │         1.14 │           6.561 │         0.66 │ 1 day, 2:22:00 │    5     0     1  83.3 │
│ PEPE/USDT:USDT │     10 │         0.69 │           6.145 │         0.61 │       13:12:00 │    9     0     1  90.0 │
│  BNB/USDT:USDT │      1 │         1.53 │           1.533 │         0.15 │        1:30:00 │    1     0     0   100 │
│  BTC/USDT:USDT │      0 │          0.0 │           0.000 │          0.0 │           0:00 │    0     0     0     0 │
│  ETH/USDT:USDT │      0 │          0.0 │           0.000 │          0.0 │           0:00 │    0     0     0     0 │
│ DOGE/USDT:USDT │      5 │        -0.19 │          -0.986 │         -0.1 │       18:33:00 │    4     0     1  80.0 │
│          TOTAL │     73 │          2.0 │         142.548 │        14.25 │       10:23:00 │   69     0     4  94.5 │
└────────────────┴────────┴──────────────┴─────────────────┴──────────────┴────────────────┴────────────────────────┘
...
┡━━━━━━━━━━━╇━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━┩
│     OTHER │      73 │          2.0 │         142.548 │        14.25 │     10:23:00 │   69     0     4  94.5 │
│     TOTAL │      73 │          2.0 │         142.548 │        14.25 │     10:23:00 │   69     0     4  94.5 │
└───────────┴─────────┴──────────────┴─────────────────┴──────────────┴──────────────┴────────────────────────┘
                                                        EXIT REASON STATS                                                         
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━┓
...
┡━━━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━┩
│      sell_profit_q_t_1 ( ) │     9 │         2.85 │          24.991 │          2.5 │         14:32:00 │    9     0     0   100 │
│ sell_profit_u_bear_1_1 ( ) │    16 │         1.42 │          22.161 │         2.22 │          0:33:00 │   16     0     0   100 │
│ sell_profit_u_bear_2_1 ( ) │     6 │         2.36 │          14.017 │          1.4 │          0:25:00 │    6     0     0   100 │
│     sell_profit_w_3_17 ( ) │     3 │          3.6 │          10.531 │         1.05 │          2:50:00 │    3     0     0   100 │
│      sell_profit_w_9_6 ( ) │     1 │         9.76 │           9.657 │         0.97 │         21:00:00 │    1     0     0   100 │
│     sell_profit_w_4_16 ( ) │     2 │         4.41 │           8.721 │         0.87 │          3:00:00 │    2     0     0   100 │
│     sell_profit_w_4_23 ( ) │     2 │         4.39 │           8.226 │         0.82 │  1 day, 15:52:00 │    2     0     0   100 │
│      sell_profit_q_t_3 ( ) │     1 │         7.33 │           7.040 │          0.7 │          5:00:00 │    1     0     0   100 │
│ sell_profit_u_bear_3_1 ( ) │     2 │         3.53 │           6.650 │         0.66 │          0:30:00 │    2     0     0   100 │
│ sell_profit_u_bear_1_2 ( ) │     4 │         1.59 │           6.236 │         0.62 │          0:34:00 │    4     0     0   100 │
│     sell_profit_w_5_16 ( ) │     1 │         5.48 │           5.473 │         0.55 │          0:30:00 │    1     0     0   100 │
│ sell_profit_u_bear_5_1 ( ) │     1 │          5.1 │           4.968 │          0.5 │          0:30:00 │    1     0     0   100 │
│    sell_profit_d_u_4_2 ( ) │     1 │         4.69 │           4.662 │         0.47 │          3:30:00 │    1     0     0   100 │
│ sell_profit_u_bear_4_1 ( ) │     1 │         4.98 │           4.615 │         0.46 │          0:15:00 │    1     0     0   100 │
│ sell_profit_u_bull_1_1 ( ) │     3 │         1.43 │           4.153 │         0.42 │          0:25:00 │    3     0     0   100 │
│      sell_profit_w_3_3 ( ) │     1 │         3.46 │           3.404 │         0.34 │          3:00:00 │    1     0     0   100 │
│      sell_profit_p_t_1 ( ) │     2 │         1.73 │           3.270 │         0.33 │          0:52:00 │    2     0     0   100 │
│ sell_profit_u_bear_3_2 ( ) │     1 │         3.08 │           3.006 │          0.3 │          0:15:00 │    1     0     0   100 │
│ sell_profit_u_bear_2_3 ( ) │     1 │          2.8 │           2.744 │         0.27 │          0:15:00 │    1     0     0   100 │
│ sell_profit_o_bull_2_1 ( ) │     1 │          2.6 │           2.585 │         0.26 │          0:30:00 │    1     0     0   100 │
│ sell_profit_o_bull_2_2 ( ) │     1 │         2.08 │           2.001 │          0.2 │          0:45:00 │    1     0     0   100 │
│      sell_profit_w_2_5 ( ) │     1 │          2.1 │           1.952 │          0.2 │  1 day, 17:45:00 │    1     0     0   100 │
│ sell_profit_o_bull_1_2 ( ) │     1 │         1.82 │           1.795 │         0.18 │          0:15:00 │    1     0     0   100 │
│ sell_profit_u_bull_1_2 ( ) │     1 │         1.79 │           1.767 │         0.18 │          0:15:00 │    1     0     0   100 │
│ sell_profit_o_bull_1_1 ( ) │     1 │         1.73 │           1.725 │         0.17 │          0:15:00 │    1     0     0   100 │
│ sell_profit_u_bull_1_4 ( ) │     1 │         1.71 │           1.711 │         0.17 │          2:45:00 │    1     0     0   100 │
│ sell_profit_o_bull_1_4 ( ) │     1 │         1.74 │           1.634 │         0.16 │          0:45:00 │    1     0     0   100 │
│    sell_profit_d_u_1_3 ( ) │     1 │         1.47 │           1.439 │         0.14 │          1:30:00 │    1     0     0   100 │
│      sell_profit_t_1_3 ( ) │     1 │         1.47 │           1.394 │         0.14 │          2:45:00 │    1     0     0   100 │
│    sell_profit_d_u_1_2 ( ) │     1 │          1.3 │           1.296 │         0.13 │          1:15:00 │    1     0     0   100 │
│    sell_stoploss_u_e_1 ( ) │     4 │        -8.07 │         -31.278 │        -3.13 │ 4 days, 11:11:00 │    0     0     4     0 │
│                      TOTAL │    73 │          2.0 │         142.548 │        14.25 │         10:23:00 │   69     0     4  94.5 │
└────────────────────────────┴───────┴──────────────┴─────────────────┴──────────────┴──────────────────┴────────────────────────┘
                                                            MIXED TAG STATS                                                            
┏━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━┓
...
┡━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━┩
│           │  sell_profit_q_t_1 ( │      9 │         2.85 │          24.991 │          2.5 │         14:32:00 │        9     0     0 │
│           │                    ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_u_bear_… │     16 │         1.42 │          22.161 │         2.22 │          0:33:00 │       16     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_u_bear_… │      6 │         2.36 │          14.017 │          1.4 │          0:25:00 │        6     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_w_3_17 ( │      3 │          3.6 │          10.531 │         1.05 │          2:50:00 │        3     0     0 │
│           │                    ) │        │              │                 │              │                  │                  100 │
│           │  sell_profit_w_9_6 ( │      1 │         9.76 │           9.657 │         0.97 │         21:00:00 │        1     0     0 │
│           │                    ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_w_4_16 ( │      2 │         4.41 │           8.721 │         0.87 │          3:00:00 │        2     0     0 │
│           │                    ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_w_4_23 ( │      2 │         4.39 │           8.226 │         0.82 │  1 day, 15:52:00 │        2     0     0 │
│           │                    ) │        │              │                 │              │                  │                  100 │
│           │  sell_profit_q_t_3 ( │      1 │         7.33 │           7.040 │          0.7 │          5:00:00 │        1     0     0 │
│           │                    ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_u_bear_… │      2 │         3.53 │           6.650 │         0.66 │          0:30:00 │        2     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_u_bear_… │      4 │         1.59 │           6.236 │         0.62 │          0:34:00 │        4     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_w_5_16 ( │      1 │         5.48 │           5.473 │         0.55 │          0:30:00 │        1     0     0 │
│           │                    ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_u_bear_… │      1 │          5.1 │           4.968 │          0.5 │          0:30:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │  sell_profit_d_u_4_2 │      1 │         4.69 │           4.662 │         0.47 │          3:30:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_u_bear_… │      1 │         4.98 │           4.615 │         0.46 │          0:15:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_u_bull_… │      3 │         1.43 │           4.153 │         0.42 │          0:25:00 │        3     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │  sell_profit_w_3_3 ( │      1 │         3.46 │           3.404 │         0.34 │          3:00:00 │        1     0     0 │
│           │                    ) │        │              │                 │              │                  │                  100 │
│           │  sell_profit_p_t_1 ( │      2 │         1.73 │           3.270 │         0.33 │          0:52:00 │        2     0     0 │
│           │                    ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_u_bear_… │      1 │         3.08 │           3.006 │          0.3 │          0:15:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_u_bear_… │      1 │          2.8 │           2.744 │         0.27 │          0:15:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_o_bull_… │      1 │          2.6 │           2.585 │         0.26 │          0:30:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_o_bull_… │      1 │         2.08 │           2.001 │          0.2 │          0:45:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │  sell_profit_w_2_5 ( │      1 │          2.1 │           1.952 │          0.2 │  1 day, 17:45:00 │        1     0     0 │
│           │                    ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_o_bull_… │      1 │         1.82 │           1.795 │         0.18 │          0:15:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_u_bull_… │      1 │         1.79 │           1.767 │         0.18 │          0:15:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_o_bull_… │      1 │         1.73 │           1.725 │         0.17 │          0:15:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_u_bull_… │      1 │         1.71 │           1.711 │         0.17 │          2:45:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │ sell_profit_o_bull_… │      1 │         1.74 │           1.634 │         0.16 │          0:45:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │  sell_profit_d_u_1_3 │      1 │         1.47 │           1.439 │         0.14 │          1:30:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │  sell_profit_t_1_3 ( │      1 │         1.47 │           1.394 │         0.14 │          2:45:00 │        1     0     0 │
│           │                    ) │        │              │                 │              │                  │                  100 │
│           │  sell_profit_d_u_1_2 │      1 │          1.3 │           1.296 │         0.13 │          1:15:00 │        1     0     0 │
│           │                  ( ) │        │              │                 │              │                  │                  100 │
│           │  sell_stoploss_u_e_1 │      4 │        -8.07 │         -31.278 │        -3.13 │ 4 days, 11:11:00 │        0     0     4 │
│           │                  ( ) │        │              │                 │              │                  │                    0 │
│     TOTAL │                      │     73 │          2.0 │         142.548 │        14.25 │         10:23:00 │       69     0     4 │
│           │                      │        │              │                 │              │                  │                 94.5 │
└───────────┴──────────────────────┴────────┴──────────────┴─────────────────┴──────────────┴──────────────────┴──────────────────────┘
                         SUMMARY METRICS                          
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
...
│ Backtesting to                │ 2026-04-01 03:00:00            │
│ Trading Mode                  │ Isolated Futures               │
│ Max open trades               │ 10                             │
│                               │                                │
│ Total/Daily Avg Trades        │ 73 / 0.06                      │
│ Starting balance              │ 1000 USDT                      │
│ Final balance                 │ 1142.548 USDT                  │
│ Absolute profit               │ 142.548 USDT                   │
│ Total profit %                │ 14.25%                         │
│ CAGR %                        │ 4.19%                          │
│ Sortino                       │ 1.73                           │
│ Sharpe                        │ 0.82                           │
...
│ SQN                           │ 5.94                           │
│ Profit factor                 │ 5.56                           │
│ Expectancy (Ratio)            │ 1.95 (0.25)                    │
│ Avg. daily profit             │ 0.12 USDT                      │
│ Avg. stake amount             │ 97.303 USDT                    │
│ Total trade volume            │ 14363.058 USDT                 │
│                               │                                │
│ Best Pair                     │ NEAR/USDT:USDT 2.41%           │
│ Worst Pair                    │ DOGE/USDT:USDT -0.10%          │
│ Best trade                    │ ETC/USDT:USDT 9.76%            │
│ Worst trade                   │ DOGE/USDT:USDT -9.10%          │
│ Best day                      │ 25.419 USDT                    │
│ Worst day                     │ -9.097 USDT                    │
│ Days win/draw/lose            │ 35 / 976 / 4                   │
│ Min/Max/Avg. Duration Winners │ 0d 00:15 / 2d 12:00 / 0d 04:47 │
│ Min/Max/Avg. Duration Losers  │ 2d 20:00 / 6d 16:45 / 4d 11:11 │
│ Max Consecutive Wins / Loss   │ 53 / 2                         │
│ Rejected Entry signals        │ 0                              │
│ Entry/Exit Timeouts           │ 0 / 0                          │
│                               │                                │
│ Min balance                   │ 1001.962 USDT                  │
│ Max balance                   │ 1160.24 USDT                   │
│ Max % of account underwater   │ 1.52%                          │
│ Absolute drawdown             │ 17.692 USDT (1.52%)            │
│ Drawdown duration             │ 41 days 19:00:00               │
│ Profit at drawdown start      │ 160.24 USDT                    │
│ Profit at drawdown end        │ 142.548 USDT                   │
│ Drawdown start                │ 2026-02-06 06:45:00            │
│ Drawdown end                  │ 2026-03-20 01:45:00            │
│ Market change                 │ 111.35%                        │
└───────────────────────────────┴────────────────────────────────┘

Backtested 2023-01-01 00:00:00 -> 2026-04-01 03:00:00 | Max open trades : 10
                                                           STRATEGY SUMMARY                                                            
┏━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━┓
┃                    ┃        ┃              ┃                 ┃              ┃              ┃    Win  Draw  Loss ┃                   ┃
┃           Strategy ┃ Trades ┃ Avg Profit % ┃ Tot Profit USDT ┃ Tot Profit % ┃ Avg Duration ┃               Win% ┃          Drawdown ┃
┡━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━┩
│ NostalgiaForInfin… │     73 │         2.00 │         142.548 │        14.25 │     10:23:00 │     69     0     4 │       17.692 USDT │
│                    │        │              │                 │              │              │               94.5 │             1.52% │
└────────────────────┴────────┴──────────────┴─────────────────┴──────────────┴──────────────┴────────────────────┴───────────────────┘
