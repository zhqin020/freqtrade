...
class NFINextMultiOffsetAndHO2(IStrategy):
   ...
   # Multi Offset
    ...
    leverage_long = IntParameter(1, 5, default=2, load=True, space='buy', optimize=True)
    leverage_short = IntParameter(1, 5, default=1, load=True, space='sell', optimize=True)
    ...
    def sell_stoploss(self, current_profit: float, last_candle, trade: 'Trade', current_time: 'datetime', max_loss: float, max_profit: float) -> tuple:
        if (current_profit < -0.03) & (last_candle['close'] < last_candle['ema_200']) & (((last_candle['ema_200'] - last_candle['close']) / last_candle['close']) < self.sell_custom_stoploss_under_rel_1.value) & (last_candle['rsi'] > last_candle['rsi_1h'] + self.sell_custom_stoploss_under_rsi_diff_1.value) & (last_candle['cmf'] < -0.25) & (last_candle['sma_200_dec_24']) & (last_candle['ema_25'] < last_candle['ema_50']) & (max_profit < 0.02) & (current_time - timedelta(minutes=960) > trade.open_date_utc):
            return True, 'signal_stoploss_u_1'

        # Under EMA200, pair & BTC negative, low max rate
        elif (-0.1 > current_profit > -0.14) & (last_candle['btc_not_downtrend_1h'] == False) & (last_candle['moderi_32'] == False) & (last_candle['moderi_64'] == False) & (max_profit < 0.01) & (max_loss < 0.14) & (last_candle['sma_200_dec_24']) & (last_candle['cmf'] < -0.1) & (last_candle['close'] < last_candle['ema_200']) & (last_candle['ema_25'] < last_candle['ema_50']) & (last_candle['cti'] < -0.9) & (current_time - timedelta(minutes=300) > trade.open_date_utc):
            return True, 'signal_stoploss_u_b_1'

        # Under EMA200, pair & BTC negative, CTI, Elder Ray Index negative, normal max rate
        elif (-0.1 > current_profit > -0.2) & (last_candle['btc_not_downtrend_1h'] == False) & (last_candle['moderi_32'] == False) & (last_candle['moderi_64'] == False) & (last_candle['moderi_96'] == False) & (max_profit < 0.03) & (max_loss < 0.2) & (last_candle['sma_200_dec_24'])& (last_candle['sma_200_dec_20_1h']) & (last_candle['cmf'] < -0.5) & (last_candle['close'] < last_candle['ema_200']) & (last_candle['ema_25'] < last_candle['ema_50']) & (last_candle['cti'] < -0.9) & (last_candle['r_480'] < -98.0) & (current_time - timedelta(minutes=360) > trade.open_date_utc):
            return True, 'signal_stoploss_u_b_2'

        elif (self.sell_custom_stoploss_long_profit_min_1.value < current_profit < -0.03) & (current_profit > (-max_loss + self.sell_custom_stoploss_long_recover_1.value)) & (last_candle['cmf'] < 0.0) & (last_candle['close'] < last_candle['ema_200']) & (last_candle['rsi'] > last_candle['rsi_1h'] + self.sell_custom_stoploss_long_rsi_diff_1.value) & (last_candle['sma_200_dec_24']) & (current_time - timedelta(minutes=960) > trade.open_date_utc):
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        # This custom exit tree is long-only logic.
        # Shorts are managed by exit_short / ROI / stoploss rules.
        if trade.is_short:
            return None
        ...
        if self.sell_condition_1_enable.value & (last_candle['rsi'] > self.sell_rsi_bb_1.value) & (last_candle['close'] > last_candle['bb20_2_upp']) & (previous_candle_1['close'] > previous_candle_1['bb20_2_upp']) & (previous_candle_2['close'] > previous_candle_2['bb20_2_upp']) & (previous_candle_3['close'] > previous_candle_3['bb20_2_upp']) & (previous_candle_4['close'] > previous_candle_4['bb20_2_upp']) & (previous_candle_5['close'] > previous_candle_5['bb20_2_upp']):
            if (last_candle['close'] > last_candle['ema_200']):
                ...
                elif (max_loss > 0.15) & (current_profit > -0.015) & (last_candle['rsi'] > (self.sell_rsi_bb_1.value + 2)):
        ...
        # Sell signal 2
            ...
            if (last_candle['close'] > last_candle['ema_200']):
                ...
                elif (max_loss > 0.12) & (current_profit > -0.02) & (last_candle['rsi'] > (self.sell_rsi_bb_2.value + 3)):
    ...
    def leverage(self, pair: str, current_time: datetime, current_rate: float,
                 ...
                 **kwargs) -> float:
        desired = self.leverage_short.value if side == 'short' else self.leverage_long.value
        return float(min(desired, max_leverage))
    ...
    def informative_pairs(self):
        ...
        informative_pairs.append(('BTC/USDT:USDT', self.info_timeframe))
    ...
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # technical.indicators.zema is deprecated; use dema as direct replacement.
        dataframe['zema'] = dema(dataframe, period=61)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.has_BTC_base_tf:
            btc_base_tf = self.dp.get_pair_dataframe("BTC/USDT:USDT", self.timeframe)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if conditions:
            ...
            dataframe.loc[enter_mask, 'enter_long'] = 1

        # Short entry: only in clear downtrends to avoid fighting strong uptrends.
        dataframe.loc[:, 'enter_short'] = 0
        short_logic = []
        short_logic.append(dataframe['close'] < dataframe['ema_200'])
        short_logic.append(dataframe['ema_12'] < dataframe['ema_26'])
        short_logic.append(dataframe['ema_25'] < dataframe['ema_50'])
        short_logic.append(dataframe['sma_200_dec_24'])
        short_logic.append(dataframe['rsi'] > 56)
        short_logic.append(dataframe['rsi_1h'] > 52)
        short_logic.append(dataframe['ewo'] < 0)
        short_logic.append(dataframe['enter_long'] == 0)
        short_logic.append(dataframe['volume'] > 0)
        short_mask = reduce(lambda x, y: x & y, short_logic)
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        short_exit_logic = []
        short_exit_logic.append(dataframe['volume'] > 0)
        short_exit_logic.append(
            (dataframe['rsi'] < 36) |
            (dataframe['rsi_1h'] < 42) |
            (dataframe['close'] > dataframe['ema_20']) |
            (dataframe['ema_12'] > dataframe['ema_26'])
        )
        short_exit_mask = reduce(lambda x, y: x & y, short_exit_logic)
...
'''
backtesting result
(.venv) watson@u24:~/work/freqtrd$ freqtrade backtesting --strategy NFINextMultiOffsetAndHO2 --config user_data/config.json --timerange 20250101- --strategy-path user_data/freqtrade-strategies/strategies/NFINextMultiOffsetAndHO2


2026-04-03 12:56:56,774 - NFINextMultiOffsetAndHO2 - WARNING - The 'hold-trades.json' file was not found. Looked in 
'/home/watson/work/freqtrd/user_data/freqtrade-strategies/strategies/NFINextMultiOffsetAndHO2' and 
'/home/watson/work/freqtrd/user_data/freqtrade-strategies/strategies/NFINextMultiOffsetAndHO2'. HOLD support disabled.
2026-04-03 12:57:34,855 - freqtrade.misc - INFO - dumping json to 
"/home/watson/work/freqtrd/user_data/backtest_results/backtest-result-2026-04-03_12-57-34.meta.json"
Result for strategy NFINextMultiOffsetAndHO2
                                                  BACKTESTING REPORT                                                  
┏━━━━━━━━━━━━━━━━┳━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━┓
┃           Pair ┃ Trades ┃ Avg Profit % ┃ Tot Profit USDT ┃ Tot Profit % ┃    Avg Duration ┃  Win  Draw  Loss  Win% ┃
┡━━━━━━━━━━━━━━━━╇━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━┩
│  XRP/USDT:USDT │      8 │         2.11 │          16.820 │         1.68 │         7:17:00 │    7     0     1  87.5 │
│  ADA/USDT:USDT │      9 │          1.8 │          15.994 │          1.6 │         0:18:00 │    7     0     2  77.8 │
│  SUI/USDT:USDT │      5 │         2.12 │          10.493 │         1.05 │         1:16:00 │    5     0     0   100 │
│ ATOM/USDT:USDT │      7 │         1.41 │           9.795 │         0.98 │         2:10:00 │    7     0     0   100 │
│ NEAR/USDT:USDT │      6 │         1.64 │           9.753 │         0.98 │         1:41:00 │    6     0     0   100 │
│ LINK/USDT:USDT │     12 │         0.81 │           9.692 │         0.97 │         3:55:00 │   11     0     1  91.7 │
│  BNB/USDT:USDT │      5 │          1.8 │           8.742 │         0.87 │         7:42:00 │    5     0     0   100 │
│  BTC/USDT:USDT │      6 │         0.64 │           3.714 │         0.37 │        10:02:00 │    6     0     0   100 │
│  ETH/USDT:USDT │     10 │         -0.0 │           0.089 │         0.01 │        21:31:00 │    9     0     1  90.0 │
│  ETC/USDT:USDT │      8 │        -0.34 │          -2.688 │        -0.27 │        13:29:00 │    7     0     1  87.5 │
│ DOGE/USDT:USDT │      3 │        -1.18 │          -3.554 │        -0.36 │         7:12:00 │    2     0     1  66.7 │
│  LTC/USDT:USDT │      4 │         -1.0 │          -3.758 │        -0.38 │         5:26:00 │    3     0     1  75.0 │
│ PEPE/USDT:USDT │      9 │        -1.64 │         -14.557 │        -1.46 │         5:47:00 │    6     0     3  66.7 │
│ AVAX/USDT:USDT │     10 │        -1.78 │         -17.727 │        -1.77 │ 1 day, 10:52:00 │    8     0     2  80.0 │
│  SOL/USDT:USDT │      8 │        -4.25 │         -33.756 │        -3.38 │         7:48:00 │    3     0     5  37.5 │
│          TOTAL │    110 │         0.08 │           9.052 │         0.91 │         9:42:00 │   92     0    18  83.6 │
└────────────────┴────────┴──────────────┴─────────────────┴──────────────┴─────────────────┴────────────────────────┘
...
┡━━━━━━━━━━━╇━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━┩
│     OTHER │     110 │         0.08 │           9.052 │         0.91 │      9:42:00 │   92     0    18  83.6 │
│     TOTAL │     110 │         0.08 │           9.052 │         0.91 │      9:42:00 │   92     0    18  83.6 │
└───────────┴─────────┴──────────────┴─────────────────┴──────────────┴──────────────┴────────────────────────┘
                                                      EXIT REASON STATS                                                      
┏━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━┓
...
┡━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━┩
│    trailing_stop_loss │    27 │         2.05 │          55.050 │          5.5 │         11:38:00 │   21     0     6  77.8 │
│     signal_profit_u_0 │    28 │         1.39 │          38.708 │         3.87 │          0:11:00 │   28     0     0   100 │
│     signal_profit_u_1 │    14 │         2.29 │          31.816 │         3.18 │          0:40:00 │   14     0     0   100 │
│   signal_profit_u_e_1 │    24 │         0.91 │          21.763 │         2.18 │          3:57:00 │   24     0     0   100 │
│     sell_signal_2_1_1 │     3 │         1.12 │           3.262 │         0.33 │  1 day, 13:27:00 │    3     0     0   100 │
│   signal_profit_w_1_2 │     1 │         2.63 │           2.624 │         0.26 │          0:10:00 │    1     0     0   100 │
│   signal_profit_w_1_1 │     1 │         1.82 │           1.803 │         0.18 │          7:00:00 │    1     0     0   100 │
│         sell_signal_8 │     1 │        -18.6 │         -18.497 │        -1.85 │ 12 days, 9:55:00 │    0     0     1     0 │
│ signal_stoploss_u_b_1 │    11 │       -11.69 │        -127.477 │       -12.75 │         20:38:00 │    0     0    11     0 │
│                 TOTAL │   110 │         0.08 │           9.052 │         0.91 │          9:42:00 │   92     0    18  83.6 │
└───────────────────────┴───────┴──────────────┴─────────────────┴──────────────┴──────────────────┴────────────────────────┘
                                                             MIXED TAG STATS                                                              
┏━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━┓
...
│ Backtesting to                │ 2026-04-02 15:10:00             │
│ Trading Mode                  │ Isolated Futures                │
│ Max open trades               │ 5                               │
│                               │                                 │
│ Total/Daily Avg Trades        │ 110 / 0.24                      │
│ Starting balance              │ 1000 USDT                       │
│ Final balance                 │ 1009.052 USDT                   │
│ Absolute profit               │ 9.052 USDT                      │
│ Total profit %                │ 0.91%                           │
│ CAGR %                        │ 0.72%                           │
│ Sortino                       │ 0.07                            │
│ Sharpe                        │ 0.08                            │
...
│ Avg. stake amount             │ 98.946 USDT                     │
│ Total trade volume            │ 43588.367 USDT                  │
│                               │                                 │
│ Best Pair                     │ XRP/USDT:USDT 1.68%             │
│ Worst Pair                    │ SOL/USDT:USDT -3.38%            │
│ Best trade                    │ ADA/USDT:USDT 5.69%             │
│ Worst trade                   │ AVAX/USDT:USDT -18.60%          │
│ Best day                      │ 10.813 USDT                     │
│ Worst day                     │ -25.327 USDT                    │
│ Days win/draw/lose            │ 40 / 392 / 12                   │
│ Min/Max/Avg. Duration Winners │ 0d 00:05 / 5d 14:50 / 0d 05:54  │
│ Min/Max/Avg. Duration Losers  │ 0d 00:00 / 12d 09:55 / 1d 05:10 │
│ Max Consecutive Wins / Loss   │ 19 / 3                          │
│ Rejected Entry signals        │ 12                              │
│ Entry/Exit Timeouts           │ 0 / 0                           │
│                               │                                 │
│ Min balance                   │ 982.793 USDT                    │
│ Max balance                   │ 1036.859 USDT                   │
│ Max % of account underwater   │ 4.33%                           │
│ Absolute drawdown             │ 44.852 USDT (4.33%)             │
│ Drawdown duration             │ 197 days 20:10:00               │
│ Profit at drawdown start      │ 36.859 USDT                     │
│ Profit at drawdown end        │ -7.993 USDT                     │
│ Drawdown start                │ 2025-07-06 21:25:00             │
│ Drawdown end                  │ 2026-01-20 17:35:00             │
│ Market change                 │ -58.99%                         │
└───────────────────────────────┴─────────────────────────────────┘

Backtested 2025-01-01 00:00:00 -> 2026-04-02 15:10:00 | Max open trades : 5
                                                                STRATEGY SUMMARY                                                                 
┏━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━┓
┃                Strategy ┃ Trades ┃ Avg Profit % ┃ Tot Profit USDT ┃ Tot Profit % ┃ Avg Duration ┃  Win  Draw  Loss  Win% ┃           Drawdown ┃
┡━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━┩
│ NFINextMultiOffsetAndH… │    110 │         0.08 │           9.052 │         0.91 │      9:42:00 │   92     0    18  83.6 │ 44.852 USDT  4.33% │
└─────────────────────────┴────────┴──────────────┴─────────────────┴──────────────┴──────────────┴────────────────────────┴────────────────────┘
